...
('Chave presencial (de presenca)'),
('Chave com telecomando canivete'),
('Chave com telecomando nao canivete (fura bolso)'),
...
WHERE m.name = 'Nissan' AND kt.name = 'Chave presencial (de presenca)'
...
FROM manufacturers m, key_types kt
WHERE m.name = 'Toyota' AND kt.name = 'Chave com telecomando nao canivete (fura bolso)'
